...
const Login: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await showAlert(
        "Login failed",
        parseErrorMessage(error, "Please check your details and try again."),
        "error"
      );
    } finally {
      setIsLoading(false);
                  ...
                  <div className="relative z-10">
                    ...
                    <form onSubmit={handleLogin} className="space-y-3.5">
                      ...
                      <div className="flex items-center justify-between gap-3 pt-1 text-[11px]">
                        ...
                        <Link
                          to="/forgot-password"
                          className="font-medium text-red-300 transition duration-300 hover:text-red-200 hover:underline"
                        >
                          Forgot password?
                        </Link>
                      </div>
