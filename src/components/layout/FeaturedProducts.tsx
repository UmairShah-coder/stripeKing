        ...
        <div className="mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-extrabold text-white sm:text-4xl">
              Featured <span className="section-title">Products</span>
            </h2>

            <p className="mt-3 max-w-2xl text-sm leading-7 text-white/55 sm:text-base">
              Explore our handpicked premium footwear collection with modern
              design, comfort, and a refined luxury finish.
            </p>
          </div>
